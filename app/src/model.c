...
void init_entities(World* world) {
	...
	//init_object(&world->trophy1, 120, 170);

	// Trophy2
	//load_model("models//trophyobjectfile.obj", &world->trophy2.model);
	//world->trophy2.texture = load_texture("textures//trophy.png");
	//init_object(&world->trophy2, -120, 170);

	// Room
	world->room.ground = load_texture("assets//textures//floor.jpg");
	world->room.back = load_texture("assets//textures//wall.jpg");
	world->room.front = load_texture("assets//textures//wall.jpg");
	world->room.left = load_texture("assets//textures//wall.jpg");
	world->room.right = load_texture("assets//textures//wall.jpg");
	world->room.top = load_texture("assets//textures//ceiling.png");
